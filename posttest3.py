...
def final_vaksinasi(nik, tahap):
    ...
    print("Suhu Tubuh         :", database["Account"][nik]["Riwayat"][tahap]["Suhu"])
    print("Tekanan Darah      :", database["Account"][nik]["Riwayat"][tahap]["Tekanan"])
    print("Nama Vaksin        :", database["Account"][nik]["Riwayat"][tahap]["NamaVaksin"])
    print("Nomor Batch Vaksin :", database["Account"][nik]["Riwayat"][tahap]["NomorBatch"])
    print("KIPI               :", database["Account"][nik]["Riwayat"][tahap]["KIPI"])
